...
import type { AlertaResponse, AuthResponse, ContratoResponse, DocumentoResponse } from '@/services/api/types'
...
export function contrato(parcial: Partial<ContratoResponse> = {}): ContratoResponse {
  return {
    id: 1,
...
export function documento(parcial: Partial<DocumentoResponse> = {}): DocumentoResponse {
  return {
    id: 1,
    contratoId: 1,
    subetapaId: null,
