  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ position: 'relative' }}>
          <div
            style={{
              ...
              color: s.idText,
              border: `1px solid ${s.idBadgeBorder}`,
              padding: '4px 12px',
              borderRadius: 4,
              marginBottom: 24,
            }}
        ...
        {/* Bottom version */}
        <div style={{ fontSize: 11, color: s.idTextMuted, position: 'relative' }}>SICOT v3.0 · GCCON-P-010</div>
      </div>
      ...
      >
        <div style={{ width: '100%', maxWidth: 340 }}>
          ...
          <div style={{ marginBottom: 14 }}>
            <label
              htmlFor="login-email"
              style={{ display: 'block', fontSize: 12, fontWeight: 500, color: s.textSecondary, marginBottom: 6 }}
            >
                ...
                >
                  {showPw ? (
                    <>
                      ...
                      <path d="M9.9 4.2A10.8 10.8 0 0 1 12 4c5 0 8.7 4 10 8a11.8 11.8 0 0 1-3.1 4.8" />
